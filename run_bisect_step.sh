...
python tools/run_tests/run_tests.py -l c++ -c dbg --use_docker -t -r ".*RpcDeadlineExpires" -n 2000 --quiet_success -a 16 -j 20 -x "report_${CURRENT_COMMIT}_sponge_log.xml" --report_suite_name "${CURRENT_COMMIT}"
