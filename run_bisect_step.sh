...
python tools/run_tests/run_tests.py -l c++ -c asan --use_docker -t -r 'ClientCancelsRequestStream' --force_use_pollers epollex -n 10000 -a 40 -j 40 --quiet_success -x "tests_${CURRENT_COMMIT}/sponge_log.xml"
